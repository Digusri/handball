...
export const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Diego Riadigos', email: 'diego.riadigos@gmail.com', role: UserRole.ADMIN, password: 'Molly2003' }, // Added password field conceptually, though handled in App logic
  { id: 'u2', name: 'Usuario Fan', email: 'user@handball.com', role: UserRole.USER, password: 'user123' },
];